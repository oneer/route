...
# ????? ColorAndToneTests ??????? test_color_tone ?????????
class ColorAndToneTests(unittest.TestCase):
    ...
    # ????? test_gray_world_equalizes_channel_means ???????? ISP ????????????
    ...
    # ????? test_identity_ccm_preserves_values ???????? ISP ????????????
    ...
    # ????? test_ccm_rejects_wrong_shape ???????? ISP ????????????
    ...
    # ????? test_gamma_rejects_non_positive_value ???????? ISP ????????????
    ...
    # ????? test_display_conversion_is_bounded_uint8 ???????? ISP ????????????
    ...
    # ????? test_metrics_are_perfect_for_identical_images ???????? ISP ????????????
