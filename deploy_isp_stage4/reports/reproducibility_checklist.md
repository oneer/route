...
```powershell
python deploy_isp_stage4/scripts/01_week0_pytorch_baseline.py --config configs/week0_baseline.yaml
$env:PYTHONIOENCODING='utf-8'; python deploy_isp_stage4/scripts/03_week1_export_validate_onnx.py --config configs/week1_onnx.yaml
python deploy_isp_stage4/scripts/04_week2_prepare_cpp_io.py
...
python deploy_isp_stage4/scripts/08_week2_compare_cpp_output.py
python deploy_isp_stage4/scripts/05_week3_backend_probe_benchmark.py
python deploy_isp_stage4/scripts/06_week4_quantization_eval.py
python deploy_isp_stage4/scripts/07_week6_pipeline_profile.py
```
