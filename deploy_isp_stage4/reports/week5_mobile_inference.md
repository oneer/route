...
```powershell
onnx2ncnn deploy_isp_stage4/models/onnx/dncnn_sidd_tiny_fp32.onnx ^
  deploy_isp_stage4/models/ncnn/dncnn_sidd_tiny.param ^
  deploy_isp_stage4/models/ncnn/dncnn_sidd_tiny.bin

ncnnoptimize deploy_isp_stage4/models/ncnn/dncnn_sidd_tiny.param ^
  deploy_isp_stage4/models/ncnn/dncnn_sidd_tiny.bin ^
  deploy_isp_stage4/models/ncnn/dncnn_sidd_tiny_opt.param ^
  deploy_isp_stage4/models/ncnn/dncnn_sidd_tiny_opt.bin 65536
```
...
```powershell
MNNConvert -f ONNX ^
  --modelFile deploy_isp_stage4/models/onnx/dncnn_sidd_tiny_fp32.onnx ^
  --MNNModel deploy_isp_stage4/models/mnn/dncnn_sidd_tiny.mnn ^
  --bizCode stage4
```
