...
- noisy：`ai_isp_stage2/datasets/sidd_tiny/val/noisy`
- clean：`ai_isp_stage2/datasets/sidd_tiny/val/clean`
- 样本数：20 对 paired RGB 图像
- manifest：`deploy_isp_stage4/data/test_inputs/week0_fixed_manifest.csv`
