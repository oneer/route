...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--cpp", default="deploy_isp_stage4/outputs/week2_cpp_io/cpp_outputs/pair_00001_cpp_output.ppm")
    parser.add_argument("--ref", default="deploy_isp_stage4/outputs/week2_cpp_io/ort_reference_png/pair_00001_ort_reference.png")
