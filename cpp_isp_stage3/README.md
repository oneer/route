# cpp_isp_stage3 — C++ High-Performance ISP Library
...
.\cpp_isp_stage3\build\tools\compare_with_reference.exe reference.cpf32 output.cpf32 1e-6
```

### Week 1 — Image Layout

```powershell
python .\cpp_isp_stage3\python_ref\visualize_week1_layout.py
```

### Week 2 — Noise Model & Basic Denoise

```powershell
python .\cpp_isp_stage3\python_ref\run_week2_noise_denoise.py
```

### Week 3 — Bilateral / NLM + SIDD Bridge

```powershell
python .\cpp_isp_stage3\python_ref\run_week3_bilateral_nlm.py
...
```powershell
python .\cpp_isp_stage3\python_ref\run_week5_tone_mapping.py
.\cpp_isp_stage3\build\bench_tone_mapping.exe | Set-Content -Encoding utf8 .\cpp_isp_stage3\reports\figures\week5\week5_tone_mapping_benchmark.csv
```

### Week 6 — Tone LUT / Fixed-Point

```powershell
python .\cpp_isp_stage3\python_ref\run_week6_tone_lut_fixed.py
.\cpp_isp_stage3\build\bench_tone_lut.exe | Set-Content -Encoding utf8 .\cpp_isp_stage3\reports\figures\week6\week6_lut_tone_mapping_benchmark.csv
```

### Week 7 — Local TM / HDR Toy

```powershell
python .\cpp_isp_stage3\python_ref\run_week7_ltm_hdr_toy.py
.\cpp_isp_stage3\build\bench_local_tone_mapping.exe | Set-Content -Encoding utf8 .\cpp_isp_stage3\reports\figures\week7\week7_local_tone_mapping_benchmark.csv
```
...
.\cpp_isp_stage3\build\run_pipeline.exe single .\cpp_isp_stage3\data\week8_pipeline\week8_scene_noisy.cpf32 .\cpp_isp_stage3\data\week8_pipeline\week8_global.cpf32 gaussian global reinhard 0.216 2.2
```
