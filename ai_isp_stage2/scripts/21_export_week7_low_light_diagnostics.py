...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", default="ai_isp_stage2/configs/low_light_sidd_tiny_unet_l1_300.yaml")
    parser.add_argument(
        "--checkpoint",
        default="ai_isp_stage2/runs/low_light_sidd_tiny_unet_l1_300/checkpoints/best_psnr.pth",
    )
    parser.add_argument("--output-dir", default="ai_isp_stage2/reports/figures/week7_low_light_diagnostics")
...
def main() -> None:
    ...
    pairs = list_pairs(Path("ai_isp_stage2") / val_cfg["noisy_dir"], Path("ai_isp_stage2") / val_cfg["clean_dir"], args.max_images)
