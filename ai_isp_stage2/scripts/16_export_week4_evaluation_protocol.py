...
DEFAULT_EVALS = [
    (
        "short_300",
        "ai_isp_stage2/reports/figures/week4_sidd_tiny_eval/metrics_summary.csv",
    ),
    (
        "standard",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="ai_isp_stage2/reports/figures/week4_evaluation_protocol")
