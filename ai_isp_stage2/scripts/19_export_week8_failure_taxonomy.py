...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--crop-metrics",
        default="ai_isp_stage2/reports/figures/week8_failure_case_crops/failure_case_crop_metrics.csv",
    )
    parser.add_argument(
        "--output-dir",
        default="ai_isp_stage2/reports/figures/week8_failure_taxonomy",
    )
