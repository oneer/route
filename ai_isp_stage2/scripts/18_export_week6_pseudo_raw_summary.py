...
DEFAULT_RUNS = [
    ("rgb_300", "ai_isp_stage2/configs/paired_rgb_sidd_tiny_dncnn_l2_300.yaml"),
    ("pseudo_rggb_300", "ai_isp_stage2/configs/pseudo_raw_sidd_tiny_dncnn_l2_300.yaml"),
]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="ai_isp_stage2/reports/figures/week6_pseudo_raw_training")
