...
DEFAULT_CONFIGS = [
    "ai_isp_stage2/configs/paired_rgb_sidd_tiny_nafnet_lite_l1_300.yaml",
    "ai_isp_stage2/configs/paired_rgb_sidd_tiny_nafnet_lite_l1_1000.yaml",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="ai_isp_stage2/reports/figures/week5_nafnet_analysis")
