...
```bash
python ai_isp_stage2/scripts/10_make_failure_case_crops.py --runs ai_isp_stage2/runs/paired_rgb_sidd_tiny_dncnn_l2_2000 ai_isp_stage2/runs/paired_rgb_sidd_tiny_dncnn_l1_2000 ai_isp_stage2/runs/paired_rgb_sidd_tiny_dncnn_l2_patch64_2000 ai_isp_stage2/runs/paired_rgb_sidd_tiny_unet_l1_1000 ai_isp_stage2/runs/paired_rgb_sidd_tiny_nafnet_lite_l1_1000 ai_isp_stage2/runs/low_light_sidd_tiny_unet_l1_300 --output-dir ai_isp_stage2/reports/figures/week8_failure_case_crops --crop-size 96 --zoom 3
```

输出文件：

```text
ai_isp_stage2/reports/figures/week8_failure_case_crops/failure_case_crop_sheet.png
ai_isp_stage2/reports/figures/week8_failure_case_crops/failure_case_crop_metrics.csv
```
...
```text
ai_isp_stage2/scripts/19_export_week8_failure_taxonomy.py
```
...
```text
ai_isp_stage2/reports/figures/week8_failure_taxonomy/week8_failure_taxonomy.csv
ai_isp_stage2/reports/figures/week8_failure_taxonomy/week8_failure_taxonomy.md
```
