...
- `stage2_ai_isp/ai_isp/data/toy_rgb_dataset.py`
- `stage2_ai_isp/ai_isp/models/tiny_cnn.py`
- `stage2_ai_isp/ai_isp/engine/train.py`
- `stage2_ai_isp/reports/week1_toy_rgb_denoise.md`
