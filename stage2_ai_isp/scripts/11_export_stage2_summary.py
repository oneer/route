...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=[
            ...
            "stage2_ai_isp/reports/figures/week7_low_light_eval/metrics_summary.csv",
        ],
    )
    parser.add_argument("--output-dir", default="stage2_ai_isp/reports/figures/week9_stage2_summary")
    parser.add_argument("--report-md", default="stage2_ai_isp/reports/week9_stage2_project_summary.md")
...
def write_markdown_report(rows: list[dict[str, str]], report_path: Path, leaderboard_csv: Path) -> None:
    ...
    lines = [
        ...
        "| 能解释工程化证据 | held-out test、ONNX 对齐和 C++ repeated latency |",
        "",
        "## 2. 运行命令",
        "",
        "```bash",
        "python stage2_ai_isp/scripts/11_export_stage2_summary.py --metric-csvs stage2_ai_isp/reports/figures/week4_sidd_tiny_standard_eval/metrics_summary.csv stage2_ai_isp/reports/figures/week7_low_light_eval/metrics_summary.csv --output-dir stage2_ai_isp/reports/figures/week9_stage2_summary --report-md stage2_ai_isp/reports/week9_stage2_project_summary.md",
        "```",
        "",
    ...
    lines += [
        ...
        "## 9. Week10-12 工程证据",
        "",
        "Week10 已补 engineering summary 与 held-out test；Week11 已完成 ONNX checker 和 PyTorch/ONNX 对齐；Week12 已完成 C++ ONNX Runtime CPU smoke test 与重复 latency。",
        "",
        "## 10. 自检问题",
        "",
